...
// @description  Display repository Star count and file/repo update time in GitHub code search results, with dual-date sorting, default-order restore, and cross-page scan aggregation.
// @author       micoe
